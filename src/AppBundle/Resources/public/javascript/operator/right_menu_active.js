$(document).ready(function () {
    ...
    if (currentUrl.indexOf('shipment') >= 0 && currentUrl.indexOf('list') >= 0 || currentUrl.indexOf('driver') >= 0 && currentUrl.indexOf('list') >= 0) {
        $("#item1 a span").css("color", "white");
        $("#item1 a i").css("color", "#1D89CF");
    }else if ( currentUrl.indexOf('shipment') >= 0){
        $("#item2 a span").css("color", "white");
        $("#item2 a i").css("color", "#1D89CF");
    }else if (currentUrl.indexOf('period_invoice') >= 0){
        $("#item2 a span").css("color", "white");
        $("#item2 a i").css("color", "#1D89CF");
    }else if (currentUrl.indexOf('customer') >= 0){
    ...
    }else if (currentUrl.indexOf('operator') >= 0){
